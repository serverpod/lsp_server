...
// ignore_for_file: prefer_void_to_null, constant_identifier_names

import 'dart:async';

import './protocol_generated.dart';
import '../helper/lsp/json_parsing.dart';
import '../helper/protocol/protocol_internal.dart';
...
Null _alwaysNull(dynamic _, [__]) => null;

bool _alwaysTrue(dynamic _, [__]) => true;
...
class Either2<T1, T2> implements ToJsonable {
  ...
  bool valueEquals(dynamic o) => map((t) => t == o, (t) => t == o);
}
